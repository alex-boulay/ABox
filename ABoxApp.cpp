...
ABoxApp::querySwapChainSupport(VkPhysicalDevice device) {
...
VkExtent2D
ABoxApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
#undef SCSC_MinC
  ...
  vkGetSwapchainImagesKHR(device, swapChain, &createInfo.minImageCount,
                          nullptr);
