...
{
public:
    InstanceWrapper(VkInstance instance = VK_NULL_HANDLE, const VkAllocationCallbacks *pAllocator = nullptr)
        : MemoryWrapper<VkInstance>(instance,
                                    std::function(
                                        [this, pAllocator]()
                                        {
...
{
public:
    SurfaceWrapper(VkInstance                   instance   = VK_NULL_HANDLE,
                   VkSurfaceKHR                 surface    = VK_NULL_HANDLE,
                   const VkAllocationCallbacks *pAllocator = nullptr

                   )
        : MemoryWrapper<VkSurfaceKHR>(surface,
                                      std::function(
                                          [this, instance, pAllocator]()
                                          {
    ...
    {
        std::cout << "Suraface Created : " << (void *) surface << std::endl;
    }
};
