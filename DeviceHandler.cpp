...
{
    VkBool32 support;
    if (VK_SUCCESS != vkGetPhysicalDeviceSurfaceSupportKHR(pD, qFamIndex, surface, &support))
    {
...
std::pair<VkResult, VkShaderModule> DeviceHandler::loadShader(uint_fast16_t deviceIndex, ShaderDataFile sdf)
{
    VkShaderModule sm     = {0};
...
VkResult DeviceHandler::addGraphicsPipeline(uint32_t deviceIndex, std::vector<ShaderDataFile> shaderFiles)
{
