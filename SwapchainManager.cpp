...
#define SCSC_CONCURENT (rQDI != gQDI)
    ...
    VkSwapchainCreateInfoKHR createInfo{.sType                 = VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR,
                                        ...
                                        .queueFamilyIndexCount = SCSC_CONCURENT *
...
VkResult SwapchainManager::createImageViews()
{
    ...
    for (size_t i = 0; i < swapChainImages.size(); i++)
    {
        ...
        return_value = vkCreateImageView(device, &createInfo, nullptr, &swapChainImageViews[i]);
...
SwapchainManager::~SwapchainManager()
{
    ...
    {
        std::cout << "swapchain handle : " << swapChain << " - device handle : " << device << std::endl;
